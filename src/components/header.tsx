  ...
  return (
    <header className="w-full bg-brand-green border-b border-green-700 shadow-md relative z-[1001]">
      <div className="mx-auto px-5 py-3 flex justify-between items-center">
        ...
        <button
          onClick={toggleMenu}
          className="lg:hidden flex flex-col justify-around w-6 h-6 bg-transparent border-none cursor-pointer p-0 z-50"
      ...
      <div
        className={`lg:hidden absolute top-full left-0 w-full bg-brand-green border-t border-green-600 shadow-xl transition-all duration-300 ease-in-out transform ${
